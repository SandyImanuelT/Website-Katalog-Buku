    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="card">
          ...
          <div class="card-body">
            <div class="col-md-12">
              <form method="POST" action="user.php?aksi=cari">
                <div class="row">
            ...
            <table class="table table-bordered">
              ...
              <form action="" method="GET">
                ...
                $sql_user = "SELECT `id_user`,`nama`, `email`, `level` FROM 
                `user`"; 
              
                if(isset($katakunci) && !empty($katakunci)){
                  $sql_user .= "where nama like '%$katakunci%'
                  OR email like '%$katakunci%'
                  OR `level` like '%$katakunci%'";
                }
                ...
                ?>
                  <tr>
                    ...
                    <td align="center">
                      <a href="edituser.php?data=<?php echo $id_user;?>" class="btn btn-xs btn-info"><i
                          class="fas fa-edit"></i></a>
                      <a href="detailuser.php?data=<?php echo $id_user;?>" class="btn btn-xs btn-info" title="Detail"><i
                          class="fas fa-eye"></i></a>
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus data 
                <?php echo $nama; ?>?'))window.location.href =  
                        'user.php?aksi=hapus&data=<?php echo 
              $id_user;?>&notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i>
                      </a>
                    </td>
                  </tr>
                  <?php $no++;}?>
...
$sql_jum = "SELECT `id_user`,`nama`, `email`, `level` FROM 
    ...
    if($jum_halaman==0){
      ...
      if($halaman!=$jum_halaman){
          ...
          »</a></li>";
          echo "<li class='page-item'>
          <a class='page-link' href='user.php?halaman=
          $jum_halaman'>
          Last</a></li>";
      }
      }?>
