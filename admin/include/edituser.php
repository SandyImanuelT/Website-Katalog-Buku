...
if(isset($_GET['data'])){
  ...
  $sql_user = "SELECT `nama`,`email`,`username`,`password`,`level`,`foto`
        ...
        <div class="card card-info">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="user.php" class="btn btn-sm btn-warning float-right"><i class="fas fa-arrow-alt-circle-left"></i>
                Kembali</a>
            </div>
          </div>
          <!-- /.card-header -->
