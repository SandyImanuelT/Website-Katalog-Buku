            ...
            <div class="card">
              ...
              <div class="col-md-12">
                ...
                <table class="table table-bordered">
                  ...
                  <!-- jumlah data yang di tampilkan di halaman -->
                  <tbody>
                  <?php 
                    $batas = 5;
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>?')) window.location.href = 'index.php?include=kategori-buku&aksi=hapus&data=<?php echo $id_kategori_buku;?>notif=hapusberhasil'" class="btn btn-xs btn-warning"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
              ...
              <ul class="pagination pagination-sm m-0 float-right">
                <?php if($jum_halaman==0){
                      ...
                      if($halaman!=1){
                        ...
                        <a class='page-link' 
                        href='index.php?include=kategori-buku&halaman=1'>First</a></li>";
                        echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-buku&
                        halaman=$sebelum'>
                        «</a></li>";
                    }
                    for($i=1; $i<=$jum_halaman; $i++){
                      if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                        if($i!=$halaman){
                          echo "<li class='page-item'><a class='page-link' 
                          href='index.php?include=kategori-buku&halaman=$i'>
                          $i</a></li>";
                        }else{
                          echo "<li class='page-item'>
                      ...
                      if($halaman!=$jum_halaman){
                        ...
                        echo "<li class='page-item'><a class='page-link' 
                        href='index.php?include=kategori-buku&halaman=$jum_halaman'>
                        Last</a></li>";
                      }
                    }?>
              </ul>
