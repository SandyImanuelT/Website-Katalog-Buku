...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      $kat = $data_k[1];
      ?>
                    <option value="<?php echo $id_kat;?>" <?php if($id_kat==$id_kategori_buku){?> selected <?php }?>><?php echo $kat;?></option>
                    <?php }?>
      ...
      $terbit = $data_t[1];
      ?>
                    <option value="<?php echo $id_terbit;?>" <?php if($id_terbit==$id_penerbit){?> selected <?php }?>>
                      <?php echo $terbit;?></option>
                    <?php }?>
                  </select>
                </div>
