    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="card">
          ...
          <div class="card-body">
            <div class="col-md-12">
              <form method="POST" action="buku.php?aksi=cari">
                <div class="row">
              ...
              <form method="GET" action="">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <a href="editbuku.php?data=<?php echo $id_buku; ?>" class="btn btn-xs btn-info" title="Edit"><i
                          class="fas fa-edit"></i></a>
                      <a href="detailbuku.php?data=<?php echo $id_buku; ?>" class="btn btn-xs btn-info"
                        title="Detail"><i class="fas fa-eye"></i></a>
                      <a href="javascript:if(confirm('Anda yakin ingin menghapus data 
                      <?php echo $judul; ?>?'))window.location.href =  
                      'buku.php?aksi=hapus&data=<?php echo 
...
$sql_jum .= "ORDER BY `k`.`kategori_buku`";
    ...
    if($jum_halaman==0){
       ...
       if($halaman!=1){
        ...
        <a class='page-link' href='buku.php?halaman=1'>
        First</a></li>";
        echo "<li class='page-item'>
        <a class='page-link' href='buku.php?halaman=$sebelum'>
        «</a></li>";
      }
      ...
      if($halaman!=$jum_halaman){
          echo "<li class='page-item'>
          <a class='page-link' href='buku.php?halaman=$setelah'>
          »</a></li>";
          echo "<li class='page-item'>
          <a class='page-link' href='buku.php?halaman=
          $jum_halaman'>
          Last</a></li>";
      }
      }?>
